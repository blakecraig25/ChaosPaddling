...
# Detect calm dark water based on low variance and medium luminance
calm_water = ((texture_variance < 0.0001) & (smoothed_image > 0.2) & (smoothed_image < 0.5)).astype(int)

# Combine frothy, calm, and regular water flow into full flow map
...
output_path = "final_route_enhanced.png"
